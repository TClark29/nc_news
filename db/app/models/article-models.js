...
function selectArticleById(id) {
  const queryStr = `SELECT articles.author, articles.body, title, topic, articles.article_id, articles.created_at, articles.votes, article_img_url, COUNT (comments.article_id) AS comment_count FROM articles 
  LEFT JOIN comments
